...
public class FinalResultsScreen : MonoBehaviour
{
    ...
    [Header("Navigation")]
    public Button nextRoundButton; // Actually "Play Again"
    ...
    void Start()
    {
        ...
        {
            nextRoundButton.onClick.AddListener(OnPlayAgainClicked);
        }
        ...
        if (webButton != null)
        {
            webButton.onClick.AddListener(OnWebsiteClicked);
        }
    }
    ...
    {
        // Reset game and go back to landing screen
    ...
    void OnDestroy()
    {
        if (nextRoundButton != null)
        {
            nextRoundButton.onClick.RemoveListener(OnPlayAgainClicked);
        }
        ...
        if (webButton != null)
        {
            webButton.onClick.RemoveListener(OnWebsiteClicked);
        }
    }
}