...
- **Video Player GameObject with RectTransform**:
...
- **Button MonoBehaviour or component Click to Fade Out**:
...
- **Eliminate Button MonoBehaviour or component**:
...
- **Answer List**:
  ...
  - **Answer Button MonoBehaviour or component** (after voting complete):
    - UI Image:
...
- **Results GameObject with RectTransform**:
...
- Video Player uses Unity UI5 Video Player element with autoplay handling

---

## SOCKET UnityEvent SYSTEM
...
## SHARE RESULTS POPUP MonoBehaviour or component

### MonoBehaviour or component Specification:
...
- **GameObject with RectTransform**:
  - RectTransform anchored position, full screen (100vw x 100vh)
  - UI Image: Color(0, 0, 0, 0.7) (dark overlay)
  - Layout Group MonoBehaviour or component, centered
  - Canvas sort order: 9999

- **Modal Box**:
  - UI Image: #030231 (dark blue)
...
- **Close Button MonoBehaviour or component** (top-right):
  - RectTransform anchored position, top 1.39vh, right 0.78vw
  - Text: "×"
  - Font size: 2.22vh
  - Color: #fffbbc
...
2. **Share Section**:
   ...
   - Color: #ffd82f (yellow)
   - Font size: 2.22vh
   - Share Button MonoBehaviour or component:
     - UI Image: #fe1d4a (red)
     - Color: #fffbbc
     - Border radius: 0.52vw
...
4. **Discount Section**:
   ...
   - Color: #fffbbc
   - Font size: 1.67vh
   - Email InputField or TMP_InputField:
     - Width: 100%
     - Padding: 1.11vh
     - Font size: 1.48vh
     - Border radius: 0.42vw
     - UI Image: #2a2a2a (dark grey)
     - Color: #fffbbc
     - Placeholder: "Enter your email"
     - Invalid state: red border (#ff4444)
   - Submit Button MonoBehaviour or component:
     - UI Image: #fe1d4a (normal) or #666 (submitted)
     - Color: #fffbbc
     - Border radius: 0.42vw
